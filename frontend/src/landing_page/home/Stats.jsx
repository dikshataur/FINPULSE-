        ...
        <div className='container p-5 align-items-center'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='mb-4 text-muted'>That's why 1.3+ crore customers trust Zerodha with ₹3.5+ lakh crores worth of equity investments.  
                    </p>
                ...
                <div className='col-6 p-5'>
                    <img src='assets/ecosystem.png' style={{width:"95%"}}/>
